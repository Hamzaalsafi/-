    ...
    >
     ...
     whileTap={{
       ...
       transition: { duration: 1 },
        ...
        style={{
          width: window.innerWidth > 375 ? window.innerWidth/window.innerHeight * 320+ "px" : "150px",
          height: window.innerWidth > 375 ?  window.innerWidth/window.innerHeight * 320+ "px" : "150px",
          maxHeight: 500,
          minHeight:130,
          minWidth:130,
          maxWidth: 500,
